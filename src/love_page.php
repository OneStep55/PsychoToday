...
<div class="px-6 py-8">
    <div class="container flex justify-between mx-auto">
        <div class="w-full lg:w-8/12">
            ...
            <div class="mt-6">
                <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="px-2 py-1 font-bold text-gray-100 bg-pink-500 rounded hover:bg-pink-400">Любовь</a>
                    </div>
            ...
            <div class="mt-6">
                <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                    <div class="flex items-center justify-between"><span class="font-light text-gray-600">Июнь 1,
                            2020</span><a href="#"
                            class="px-2 py-1 font-bold text-gray-100 bg-pink-500 rounded hover:bg-pink-400">Любовь</a>
                    </div>
                    <div class="mt-2"><a href="#" class="text-2xl font-bold text-gray-700 hover:underline">Мой отчим изменяет бобру с дуплом!</a>
                        <p class="mt-2 text-gray-600">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                            Tempora expedita dicta totam aspernatur doloremque. Excepturi iste iusto eos enim
            ...
            <div class="mt-8">
                <div class="flex">
                    <a href="psychologypage.php" class="px-3 py-2 mx-1 font-medium text-gray-500 bg-white rounded-md cursor-not-allowed">
                        назад
                    </a>
                
                    <a href="psychologypage.php" class="px-3 py-2 mx-1 font-medium text-gray-700 bg-white rounded-md hover:bg-pink-500 hover:text-white">
                        1
                    </a>
                
                    <a href="psychologypage2.php" class="px-3 py-2 mx-1 font-medium text-gray-700 bg-white rounded-md hover:bg-pink-500 hover:text-white">
                        2
                    </a>
...
<div class="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
  ...
  <div class="p-5 w-48">
     ...
     <a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a> 
  </div>
  <div class="p-5 w-48 ">
     <div class="text-xs "></div>
     <a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a> 
  </div>
  <div class="p-5 w-48">
     <div class="text-xs "></div>
     <a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#"> <span class="text-teal-600 text-xs p-1"></span></a> 
