        ...
        <div class="w-full lg:w-8/12">
            ...
            <div class="mt-8">
                <div class="flex">
                    ...
                    <a href="./violence_page.html" class="px-3 py-2 mx-1 font-medium text-gray-700 bg-white rounded-md hover:bg-blue-500 hover:text-white">
                        1
                    </a>
                
                    <a href="./violence_page2.html" class="px-3 py-2 mx-1 font-medium text-gray-700 bg-white rounded-md hover:bg-blue-500 hover:text-white">
                        2
                    </a>
